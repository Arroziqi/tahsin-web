...
import { TeacherStatus } from '@/common/type/teacher/teacherModel';
import { TeacherResponseDataType } from '@/components/modal/teacher/EditTeacherFormModal';
...
export function useTeachers() {
  ...
  return { data, loading, error, setError, refetch: fetchTeachers };
}
